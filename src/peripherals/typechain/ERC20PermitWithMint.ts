...
export interface ERC20PermitWithMintInterface extends utils.Interface {
  functions: {
...
export interface ERC20PermitWithMint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20PermitWithMintInterface;
