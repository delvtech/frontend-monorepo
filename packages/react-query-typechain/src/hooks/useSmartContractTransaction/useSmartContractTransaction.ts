...
>(
  ...
  return useMutation({
    mutationFn: async (
      ...
      // This is a unfortunate naming collision with testing-library, where
      // you'd want to avoid missing an await in a test. Doesn't apply to our
      // code though, disabling it here. This should likely be configured in
      // eslint instead.
