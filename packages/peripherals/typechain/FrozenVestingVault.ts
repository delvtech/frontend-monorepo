...
export interface FrozenVestingVaultInterface extends utils.Interface {
  functions: {
...
export interface FrozenVestingVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FrozenVestingVaultInterface;
  ...
  functions: {
    ...
    removeGrant(arg0: string, overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    removeGrant(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
