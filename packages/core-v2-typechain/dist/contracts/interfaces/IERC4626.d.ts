...
export interface IERC4626Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "asset" | "asset()" | "balanceOf" | "balanceOf(address)" | "convertToAssets" | "convertToAssets(uint256)" | "convertToShares" | "convertToShares(uint256)" | "decimals" | "decimals()" | "deposit" | "deposit(uint256,address)" | "maxDeposit" | "maxDeposit(address)" | "maxMint" | "maxMint(address)" | "maxRedeem" | "maxRedeem(address)" | "maxWithdraw" | "maxWithdraw(address)" | "mint" | "mint(uint256,address)" | "name" | "name()" | "previewDeposit" | "previewDeposit(uint256)" | "previewMint" | "previewMint(uint256)" | "previewRedeem" | "previewRedeem(uint256)" | "previewWithdraw" | "previewWithdraw(uint256)" | "redeem" | "redeem(uint256,address,address)" | "symbol" | "symbol()" | "totalAssets" | "totalAssets()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)" | "withdraw" | "withdraw(uint256,address,address)"): FunctionFragment;
