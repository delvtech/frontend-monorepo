...
export interface ERC4626TermInterface extends utils.Interface {
    functions: {
...
export interface ERC4626Term extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC4626TermInterface;
    ...
    functions: {
        ...
        reserveDetails(overrides?: CallOverrides): Promise<[
            ...
            underlyingReserve: BigNumber;
            vaultShareReserve: BigNumber;
            vaultShareReserveAsUnderlying: BigNumber;
