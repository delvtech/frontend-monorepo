...
export class Pool {
   ...
   * @see {@link https://github.com/delvtech/analysis/blob/83ca31c690caa168274ef5d8cd807d040d9b9f59/scripts/PricingModels2.py#L500} for formula source.
   ...
   * @async
   * @see {@link https://github.com/delvtech/analysis/blob/83ca31c690caa168274ef5d8cd807d040d9b9f59/scripts/PricingModels2.py#L487} for formula source.
