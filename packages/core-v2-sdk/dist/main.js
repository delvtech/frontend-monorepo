...
$parcel$export(
  $f65b6b18b897f856$exports,
  "ElementContext",
  () => $f65b6b18b897f856$export$4186b0f94a8cd1c0,
);
  ...
  getDataSource(filter) {
    const dataSource1 = this.dataSources.find((dataSource) => {
      ...
      for (const [key, value] of Object.entries(filter))
        if (!dataSource[key] !== value) isMatch = false;
      return isMatch;
    });
...
$parcel$export(
  $54e3433d3ac69f8a$exports,
  "CachedDataSource",
  () => $54e3433d3ac69f8a$export$2ed75dd8c92d9d3e,
);
...
class $54e3433d3ac69f8a$export$2ed75dd8c92d9d3e {
  constructor(cache) {
    this.cache =
      cache ??
      new (0, $parcel$interopDefault($eCQIH$lrucache))({
        max: 500,
      });
  }
  // The return type will match the return type of the callback function.
  cached(cacheKey, callback) { // The cache key will be reduced to a string
...
$parcel$export(
  $20adc394a346779f$exports,
  "ContractDataSource",
  () => $20adc394a346779f$export$f5a95cc94689234f,
);

class $20adc394a346779f$export$f5a95cc94689234f extends (0,
$54e3433d3ac69f8a$export$2ed75dd8c92d9d3e) {
...
$parcel$export(
  $d0dba6c4aa120ac9$exports,
  "HTTPDataSource",
  () => $d0dba6c4aa120ac9$export$4c0f08f860b6a287,
);

class $d0dba6c4aa120ac9$export$4c0f08f860b6a287 extends (0,
$54e3433d3ac69f8a$export$2ed75dd8c92d9d3e) {
  ...
  // Create
  post(path, options) {
    return this.cached(["post", path, options.body], () =>
  ...
  // Update
  put(path, options) {
    return this.cached(["put", path, options.body], () =>
      fetch(`${this.baseURL}${path}`, {
        ...this.defaultRequestOptions,
  ...
  // Delete
  delete(path, options = {}) {
    return this.cached(["delete", path], () =>
      fetch(`${this.baseURL}${path}`, {
        ...this.defaultRequestOptions,
...
$parcel$export(
  $bd9ebd5a6170b777$exports,
  "MultiPoolContractDataSource",
  () => $bd9ebd5a6170b777$export$3e28d0e9e34d7848,
);

class $bd9ebd5a6170b777$export$3e28d0e9e34d7848 extends (0,
$20adc394a346779f$export$f5a95cc94689234f) {
  constructor(address, provider) {
    super(
      (0, $eCQIH$elementficorev2typechain.Pool__factory).connect(
        address,
        provider,
      ),
    );
...
$parcel$export(
  $d179b418267ba386$exports,
  "MultiTermContractDataSource",
  () => $d179b418267ba386$export$2bd093a746116e9a,
);

const $4a4b662dc565d96c$export$7b6afb4232a53135 =
...
class $d179b418267ba386$export$2bd093a746116e9a extends (0,
$20adc394a346779f$export$f5a95cc94689234f) {
  constructor(address, provider) {
    super(
      (0, $eCQIH$elementficorev2typechain.Term__factory).connect(
        address,
        provider,
      ),
    );
   ...
   */ async getTermIds(fromBlock, toBlock) {
    return this.cached(["getTermIds", fromBlock, toBlock], async () => {
      const events = await this.getTransferEvents(
        ...
        (0, $eCQIH$ethers.ethers).constants.AddressZero,
        null,
        fromBlock,
        toBlock,
      );
      return Array.from(
        new Set(
          events // filter out YTs
            .filter((event) =>
              (0, $6ff8d0293b29261d$export$238876ec612ad57e)(event.args.id),
            )
  ...
  getCreatedAtBlock(termId) {
    return this.cached(["getCreatedAtBlock", termId], async () => {
      ...
      const firstTransferEvent = events.find(({ args: args }) =>
        args.id.eq(termId),
      );
   ...
   */ async lock(
    ...
    const transferSingleLogs = events.filter((event) => {
      return (
        ...
        event.args.from === (0, $eCQIH$ethers.ethers).constants.AddressZero
      );
    });
    // maybe can just check index but not verified events will be ordered
    const ytMintEvent = transferSingleLogs.find((log) =>
      (0, $4ff6911a82243538$export$e6aa4d1f02dd6fdd)(log.args.id),
    );
    const ptMintEvent = transferSingleLogs.find((log) =>
      (0, $6ff8d0293b29261d$export$238876ec612ad57e)(log.args.id),
    );
    return {
      principalTokens: (0, $eCQIH$ethers.BigNumber)
        .from(ptMintEvent.args.value)
        .toString(),
      yieldTokens: (0, $eCQIH$ethers.BigNumber)
        .from(ytMintEvent.args.value)
        .toString(),
    };
  }
}
...
$parcel$export(
  $f51a6578dfe1989b$exports,
  "ERC4626TermContractDataSource",
  () => $f51a6578dfe1989b$export$bbbba6d0f10fb94f,
);

class $f51a6578dfe1989b$export$bbbba6d0f10fb94f extends (0,
$d179b418267ba386$export$2bd093a746116e9a) {
  constructor(address, provider) {
    super(address, provider);
    this.contract = (0,
    $eCQIH$elementficorev2typechain.ERC4626Term__factory).connect(
      address,
      provider,
    );
  }
...
$parcel$export(
  $e5fa39cebc28622b$exports,
  "CompoundV3TermContractDataSource",
  () => $e5fa39cebc28622b$export$200f8c2a47155eb4,
);

class $e5fa39cebc28622b$export$200f8c2a47155eb4 extends (0,
$d179b418267ba386$export$2bd093a746116e9a) {
  constructor(address, provider) {
    super(address, provider);
    this.contract = (0,
    $eCQIH$elementficorev2typechain.CompoundV3Term__factory).connect(
      address,
      provider,
    );
  }
...
$parcel$export(
  $fe6691dc6a8bbe5c$exports,
  "TokenContractDataSource",
  () => $fe6691dc6a8bbe5c$export$f746d784fcd6629,
);

var $f00ba8e0ba7f8838$exports = {};

$parcel$export(
  $f00ba8e0ba7f8838$exports,
  "CoinGeckoAPIDataSource",
  () => $f00ba8e0ba7f8838$export$9329909b02e34fde,
);

class $f00ba8e0ba7f8838$export$9329909b02e34fde extends (0,
$d0dba6c4aa120ac9$export$4c0f08f860b6a287) {
  constructor() {
...
class $fe6691dc6a8bbe5c$export$f746d784fcd6629 {
  constructor(address, provider, options) {
    ...
    this.apiDataSource =
      options?.apiDataSource ??
      new (0, $f00ba8e0ba7f8838$export$9329909b02e34fde)();
    this.erc20DataSource =
      options?.erc20DataSource ??
      new (0, $20adc394a346779f$export$f5a95cc94689234f)(
        (0, $eCQIH$elementficorev2typechain.ERC20__factory).connect(
          address,
          provider,
        ),
      );
...
$parcel$export(
  $047c4a05380e9203$exports,
  "UnknownYieldSourceDataSource",
  () => $047c4a05380e9203$export$cf7432b8e060b664,
);

class $047c4a05380e9203$export$cf7432b8e060b664 extends (0,
$54e3433d3ac69f8a$export$2ed75dd8c92d9d3e) {
  constructor(address) {
    super();
    this.address = address;
...
$parcel$export(
  $3b777295048083ac$exports,
  "ERC4626ContractDataSource",
  () => $3b777295048083ac$export$2404bedfffaf4ac,
);

class $3b777295048083ac$export$2404bedfffaf4ac extends (0,
$20adc394a346779f$export$f5a95cc94689234f) {
  constructor(address, provider) {
    super(
      (0, $eCQIH$elementficorev2typechain.ERC4626__factory).connect(
        address,
        provider,
      ),
    );
...
$parcel$export(
  $8af14f8f6b4799b0$exports,
  "LPToken",
  () => $8af14f8f6b4799b0$export$84f20e6ecc12f354,
);
...
$parcel$export(
  $db3c4c3da11ea48c$exports,
  "MultiPool",
  () => $db3c4c3da11ea48c$export$38f2878d4d50407d,
);

var $73142241d07e4549$exports = {};

$parcel$export(
  $73142241d07e4549$exports,
  "MultiTerm",
  () => $73142241d07e4549$export$44a06e384a6d2ed0,
);

var $2361706748e2a981$exports = {};

$parcel$export(
  $2361706748e2a981$exports,
  "Token",
  () => $2361706748e2a981$export$50792b0e93539fde,
);
  ...
  constructor(address, context, dataSource) {
    ...
    if (dataSource) this.dataSource = dataSource;
      ...
      this.dataSource = context.registerDataSource(
        ...
        new (0, $fe6691dc6a8bbe5c$export$f746d784fcd6629)(
          address,
          context.provider,
          {
...
$parcel$export(
  $43a71ca2139b91c6$exports,
  "YieldSource",
  () => $43a71ca2139b91c6$export$5b513f5c41d35e50,
);
...
$parcel$export(
  $51ba50e48c247b12$exports,
  "Term",
  () => $51ba50e48c247b12$export$656c1e606ad06131,
);
var $2ababb11162a7525$exports = {};

$parcel$export(
  $2ababb11162a7525$exports,
  "PrincipalToken",
  () => $2ababb11162a7525$export$62007a0bd048d56c,
);
...
$parcel$export(
  $d42f7646c857727b$exports,
  "YieldToken",
  () => $d42f7646c857727b$export$7e27801a0b3a9d2a,
);
...
class $51ba50e48c247b12$export$656c1e606ad06131 {
  constructor(id, context, multiTerm) {
    ...
    this.principalToken = new (0, $2ababb11162a7525$export$62007a0bd048d56c)(
      id,
      context,
      this,
    );
  ...
  getYieldToken(startTimeStamp) {
    return new (0, $d42f7646c857727b$export$7e27801a0b3a9d2a)(
      this.id,
      this.context,
      this,
    );
...
class $73142241d07e4549$export$44a06e384a6d2ed0 {
  constructor(address, context, dataSource) {
    ...
    this.dataSource =
      ...
      context.registerDataSource(
        ...
        new (0, $d179b418267ba386$export$2bd093a746116e9a)(
          address,
          context.provider,
        ),
      );
   ...
   */ async getTerms(fromBlock, toBlock) {
    ...
    return termIds.map(
      (id) =>
        new (0, $51ba50e48c247b12$export$656c1e606ad06131)(
          id,
          this.context,
          this,
        ),
...
$parcel$export(
  $5c922a29083dd917$exports,
  "Pool",
  () => $5c922a29083dd917$export$14963ee5c8637e11,
);
...
async function $1817d10c133d5a0f$export$fec8442715c47d8b(end, provider) {
  const currentBlockTimestamp = await (0,
  $c55952b507d79662$export$e16a9e8da7a04919)(provider);
...
async function $8b9e4060a562c68b$export$fa72f61bcf5e310d(end, provider) {
  const seconds = await (0, $1817d10c133d5a0f$export$fec8442715c47d8b)(
    end,
    provider,
  );
...
class $5c922a29083dd917$export$14963ee5c8637e11 {
   ...
   */ constructor(id, context, multiPool) {
    ...
    this.lpToken = new (0, $8af14f8f6b4799b0$export$84f20e6ecc12f354)(
      id,
      context,
      this,
    );
   ...
   */ async getSpotPrice() {
    ...
    const daysUntilExpiry = await (0,
    $8b9e4060a562c68b$export$fa72f61bcf5e310d)(this.id, this.context.provider);
    // pool parameters
   ...
   */ async getFixedAPR() {
    ...
    const daysUntilExpiry =
      (await (0, $8b9e4060a562c68b$export$fa72f61bcf5e310d)(
        this.id,
...
class $db3c4c3da11ea48c$export$38f2878d4d50407d {
   ...
   */ constructor(address, context, dataSource) {
    ...
    this.dataSource =
      ...
      context.registerDataSource(
        ...
        new (0, $bd9ebd5a6170b777$export$3e28d0e9e34d7848)(
          address,
          context.provider,
        ),
      );
   ...
   */ async getPools(fromBlock, toBlock) {
    ...
    return poolIds.map(
      (id) =>
        new (0, $5c922a29083dd917$export$14963ee5c8637e11)(
          id,
          this.context,
          this,
        ),
...
$parcel$export(
  $a6ef1106a8ce388b$exports,
  "buyYieldTokens",
  () => $a6ef1106a8ce388b$export$6f04aa4e93ebc2f0,
);

async function $a6ef1106a8ce388b$export$6f04aa4e93ebc2f0(
  tokenAddress,
  vaultAddress,
  amount,
  signer,
...
$parcel$export(
  $98797cba267d5720$exports,
  "calcSwapConvergentCurvePool",
  () => $98797cba267d5720$export$5a396e44c774c23,
);
function $98797cba267d5720$export$5a396e44c774c23(
  tokenAmountsIn,
  tokenReserves,
) {
  return "1";
...
$parcel$export(
  $7141e549f83aab3e$exports,
  "calculateLPTokensOut",
  () => $7141e549f83aab3e$export$fc1e179e9427dc9d,
);
function $7141e549f83aab3e$export$fc1e179e9427dc9d(
  tokenAmountsIn,
  tokenReserves,
) {
  return "1";
...
$parcel$export(
  $9dde791ff857a61d$exports,
  "provideLiquidity",
  () => $9dde791ff857a61d$export$89f79baa523d0647,
);

async function $9dde791ff857a61d$export$89f79baa523d0647(
  amounts,
  tokensInAddresses,
  vaultAddress,
  slippage,
...
$parcel$export(
  $36cbfb79cc4b34b2$exports,
  "redeemLiquidity",
  () => $36cbfb79cc4b34b2$export$3d4323a2aa222f23,
);

async function $36cbfb79cc4b34b2$export$3d4323a2aa222f23(
  amount,
  poolAddress,
  signer,
  overrides = {},
...
$parcel$export(
  $9c1766b6f9f74658$exports,
  "tradePrincipalTokens",
  () => $9c1766b6f9f74658$export$4788e751b8f21c65,
);

async function $9c1766b6f9f74658$export$4788e751b8f21c65(
  amount,
  tokenInAddress,
  tokenOutAddress,
  vaultAddress,
...
$parcel$export(
  $2199ecd2883db3b5$exports,
  "withdrawLiquidity",
  () => $2199ecd2883db3b5$export$3191c47e10722ce4,
);

async function $2199ecd2883db3b5$export$3191c47e10722ce4(
  amount,
  poolAddress,
  signer,
  overrides = {},
