...
export class MultiPoolContractDataSource
  extends ContractDataSource<_Pool1>
...
export class MultiTermContractDataSource
  extends ContractDataSource<_Term1>
...
export class CoinGeckoAPIDataSource extends HTTPDataSource {
  ...
  constructor();
  getTokenPrice<ID extends string, CODE extends string>(
    id: ID,
    currency: CODE,
  ): Promise<number | null>;
}
 ...
 * @returns
 */
export function buyYieldTokens(
  tokenAddress: string,
  vaultAddress: string,
  amount: BigNumberish,
  signer: Signer,
 ...
 * @returns
 */
export function tradePrincipalTokens(
  amount: BigNumberish,
