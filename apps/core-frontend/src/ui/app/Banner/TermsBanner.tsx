...
export const TermsBanner = (): ReactElement => {
  ...
  return (
    <div className="fixed bottom-0 z-10 mb-48 h-24 w-full sm:mb-24">
      <div className="sm:min-w-min m-auto mx-4 mb-4 flex max-w-3xl flex-col items-center justify-center rounded-lg border-2 border-white bg-gray-700 p-2 sm:m-auto sm:h-12 sm:flex-row sm:p-10">
        <ElementMinLogo
