...
export default function SideBar(): ReactElement {
  return (
    <footer>
      ...
      <div className="from-principalBlue to-principalRoyalBlue fixed bottom-0 left-0 z-20 h-[72px] w-full bg-gradient-to-br lg:z-0 lg:h-full lg:w-[120px]"></div>
      ...
      <ul className="fixed left-0 bottom-4 z-20 flex w-full justify-center gap-[8vw] lg:bottom-10 lg:z-10 lg:w-[120px] lg:flex-col lg:items-center lg:gap-5">
        <SocialLink href={ElementUrl.TWITTER} title="Twitter">
          <TwitterIcon className="h-auto w-5 fill-white" />
        </SocialLink>
        <SocialLink href={ElementUrl.DISCORD} title="Discord">
          <DiscordIcon className="h-auto w-5 fill-white" />
        </SocialLink>
        <SocialLink href={ElementUrl.FORUM} title="Forum">
