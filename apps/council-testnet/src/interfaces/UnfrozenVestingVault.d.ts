...
interface UnfrozenVestingVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class UnfrozenVestingVault extends BaseContract {
  ...
  interface: UnfrozenVestingVaultInterface;
